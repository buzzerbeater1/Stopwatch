...
class WriteStopwatchVC: UIViewController {

    @IBOutlet weak var startButton: UIButton!
    @IBOutlet weak var pauseButton: UIButton!
    @IBOutlet weak var timeLabel: UILabel!
    @IBOutlet weak var section1Label: UITextField!
    @IBOutlet weak var section2Label: UITextField!
    @IBOutlet weak var section3Label: UITextField!
    @IBOutlet weak var section4Label: UITextField!
    @IBOutlet weak var section5Label: UITextField!
    @IBOutlet weak var totalTimeLabel: UITextField!
